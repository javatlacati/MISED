...
$(function() {
	let tablaProgramasInstitucionales = $('#tabla-programas-institucionales')
			.DataTable(
					{
						"language" : LENGUAJE,
						dom : 'Bfrtilp',
						...
						"columnDefs" : [ {
							...
							"render" : function(data, type, row) {
								return "<a class='btn bg-deep-orange waves-effect' style='margin-right: 7px;' "
										+ "onclick='actualizacionProgramaInstitucional(" + data + ")'>Actualizar</a>"

										+ "<a class='btn bg-red waves-effect' style='margin-right: 7px;' " 
										+ "onclick='bajaProgramaInstitucional(" + data + ")'>Eliminar</a>";
							}
						} ],
						"ajax" : {
