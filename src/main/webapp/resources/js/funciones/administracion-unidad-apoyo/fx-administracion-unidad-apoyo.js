...
var titulo = 'UNIDADES DE APOYO ' + (new Date().getFullYear());
...
function realizarActualizacionUnidadApoyo() {
    var unidadApoyo = new UnidadApoyo($("#idUnidadApoyo").val(), $("#selector-actualizacion-id-organo-direccion-estrategica").val(), $("#nombre").val(), $("#proposito").val());
...
function capturaUnidadApoyo() {
    var unidadApoyo = new UnidadApoyo("", $("#selector-id-organoDireccionEstrategica").val(), $("#nuevo-nombre").val(), $("#nuevo-proposito").val());
    if (validarCamposUnidadApoyo(unidadApoyo)) {
        $.ajax({
...
function validarCamposUnidadApoyo(_a) {
    var _b = _a.idOrganoDireccionEstrategica, idOrganoDireccionEstrategica = _b === void 0 ? "" : _b, _c = _a.nombre, nombre = _c === void 0 ? "" : _c, _d = _a.proposito, proposito = _d === void 0 ? "" : _d;
