...
CREATE TABLE USUARIO_PERMISO(
	...
	ID_USUARIO BIGINT UNIQUE REFERENCES USUARIO(ID_USUARIO) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE ACTIVIDAD_EXTEMPORANEA(
	...
	ID_USUARIO BIGINT UNIQUE REFERENCES USUARIO(ID_USUARIO) ON DELETE CASCADE ON UPDATE CASCADE,
	FASE_PLANEACION BOOLEAN,
	FASE_CALENDARIZACION BOOLEAN,
	FASE_PRIMER_CUATRIMESTRE BOOLEAN,
	FASE_SEGUNDO_CUATRIMESTRE BOOLEAN,
	FASE_TERCER_CUATRIMESTRE BOOLEAN
);

CREATE TABLE HISTORIAL_ACTIVIDAD_EXTEMPORANEA(
	ID_HISTORIAL_ACTIVIDAD_EXTEMPORANEA BIGSERIAL PRIMARY KEY,
	ID_ACTIVIDAD_EXTEMPORANEA BIGINT REFERENCES ACTIVIDAD_EXTEMPORANEA(ID_ACTIVIDAD_EXTEMPORANEA) ON DELETE CASCADE ON UPDATE CASCADE,
	ID_USUARIO BIGINT REFERENCES USUARIO(ID_USUARIO) ON DELETE CASCADE ON UPDATE CASCADE,
	SOLICITO_FASE_PLANEACION BOOLEAN,
	SOLICITO_FASE_CALENDARIZACION BOOLEAN,
	SOLICITO_FASE_PRIMER_CUATRIMESTRE BOOLEAN,
	SOLICITO_FASE_SEGUNDO_CUATRIMESTRE BOOLEAN,
	SOLICITO_FASE_TERCER_CUATRIMESTRE BOOLEAN,
	FECHA_SOLICITUD VARCHAR(100),
	HORA_SOLICITUDAD VARCHAR(20)
);
